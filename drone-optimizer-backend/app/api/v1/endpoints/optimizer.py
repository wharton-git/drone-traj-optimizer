...
async def optimize_drone_path(request: OptimizationRequest):
    ...
    return OptimizationResponse(
        ...
        pareto_front_generated=result["pareto_front_generated"],
        generated_count=result["generated_count"],
        pareto_generated_count=result["pareto_generated_count"],
        generated_pareto_basis=result["generated_pareto_basis"],
